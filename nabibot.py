...
async def cmd_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "Спасибо за покупку и отличный выбор — у тебя безупречный вкус! Мы уверены, что в нашей одежде ты почувствуешь себя уверенной и успешной 🫶🏻\n\n"
        "Нам будет приятно, если ты поделишься впечатлениями о покупке в отзыве ⭐️⭐️⭐️⭐️⭐️\n\n"
        "В знак благодарности дарим тебе доступ к онлайн тренировке от популярной платформы FitStars.\n\n"
