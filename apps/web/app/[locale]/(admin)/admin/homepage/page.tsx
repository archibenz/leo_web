...
export default function AdminHomepagePage() {
  ...
  return (
    <>
      ...
      {/* Эти настройки на белую витрину не попадают: читавший их
          /api/catalog/homepage звал лишь архивный код старой темы, и 25.09
          он удалён вместе со старым каталогом (сырое products.price).
