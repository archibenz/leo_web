...
export const WHITE_PRODUCTS: WhiteProduct[] = [
  ...
  {key: 2, en: 'Fitted Blazer Coat', ru: 'Пальто-пиджак приталенное', cat: 'outerwear', price: 34900, descEn: 'A demi-season coat cut like a blazer — clean collarless shoulders and a sculpted, buttoned waist. Fully lined.', descRu: 'Демисезонное пальто с кроем пиджака — чистые плечи без воротника и скульптурная талия на пуговицах. На подкладе.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND, CHARCOAL], image: '/images/white/products/p-795522033.jpg', nm: 795522033, gallery: ['/images/white/products/p-795522033-2.jpg', '/images/white/products/p-795522033-3.jpg']},
