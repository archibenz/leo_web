...
export const WHITE_PRODUCTS: WhiteProduct[] = [
  ...
  {key: 9, en: 'Lace Oversized Shirt', ru: 'Рубашка оверсайз с кружевом', cat: 'dresses', price: 8326, descEn: 'An oversized shirt softened with lace panels. Relaxed shoulders, a fluid drape, quietly romantic.', descRu: 'Оверсайз-рубашка, смягчённая кружевными вставками. Свободные плечи, текучий крой, тихая романтика.', compositionEn: 'Cotton with lace', compositionRu: 'Хлопок с кружевом', careEn: 'Hand wash cold', careRu: 'Ручная стирка в холодной воде', colors: [SAND, ROSE, GREY, BLACK], image: '/images/white/products/p-1113526969.jpg', nm: 1113526969, gallery: ['/images/white/products/p-1113526969-3.jpg', '/images/white/products/p-1113526969-4.jpg']},
