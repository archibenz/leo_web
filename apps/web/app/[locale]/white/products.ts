...
export const WHITE_PRODUCTS: WhiteProduct[] = [
  ...
  {key: 13, en: 'Striped Belted Coat', ru: 'Пальто в полоску с поясом', cat: 'outerwear', price: 34900, descEn: 'A long oversized coat in a fine tonal stripe, closed with a belt. Considered ease over anything.', descRu: 'Длинное оверсайз-пальто в тонкую тональную полоску, на поясе. Продуманная лёгкость поверх чего угодно.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND, CHARCOAL], image: '/images/white/products/p-814720607.jpg', nm: 814720607, gallery: ['/images/white/products/p-814720607-2.jpg', '/images/white/products/p-814720607-3.jpg', '/images/white/products/p-814720607-4.jpg']},
