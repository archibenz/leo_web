...
export const WHITE_PRODUCTS: WhiteProduct[] = [
  ...
  {key: 9, en: 'Lace Oversized Shirt', ru: 'Рубашка оверсайз с кружевом', cat: 'dresses', price: 8326, descEn: 'An oversized shirt softened with lace panels. Relaxed shoulders, a fluid drape, quietly romantic.', descRu: 'Оверсайз-рубашка, смягчённая кружевными вставками. Свободные плечи, текучий крой, тихая романтика.', compositionEn: 'Cotton with lace', compositionRu: 'Хлопок с кружевом', careEn: 'Hand wash cold', careRu: 'Ручная стирка в холодной воде', colors: [SAND, ROSE, GREY, BLACK], image: '/images/white/products/p-1113526969.jpg', nm: 1113526969, gallery: ['/images/white/products/p-1113526969-2.jpg']},
  {key: 10, en: 'Suede Skort', ru: 'Юбка-шорты замшевая', cat: 'skirts', price: 2922, descEn: 'A suede mini skort — the ease of shorts under the line of a skirt. Soft hand, clean hem.', descRu: 'Замшевая юбка-шорты — лёгкость шорт под линией юбки. Мягкая фактура, чистый низ.', compositionEn: 'Suede', compositionRu: 'Замша', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND, BROWN], image: '/images/white/products/p-1143078000.jpg', nm: 1143078000, gallery: ['/images/white/products/p-1143078000-2.jpg']},
  {key: 11, en: 'Long Belted Coat', ru: 'Пальто оверсайз с поясом', cat: 'outerwear', price: 34900, descEn: 'A long oversized demi-season coat with a self-tie belt. Dropped shoulders, a deep collar, floor-skimming.', descRu: 'Длинное оверсайз-пальто демисезона с поясом. Приспущенное плечо, глубокий воротник, длина в пол.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND, CAMEL], image: '/images/white/products/p-100797221.jpg', nm: 100797221, gallery: ['/images/white/products/p-100797221-2.jpg']},
  {key: 12, en: 'Ribbed Slit Dress', ru: 'Платье лапша с разрезом', cat: 'dresses', price: 632, descEn: 'A long ribbed knit dress that skims the body, opened by a single side slit. Second-skin soft.', descRu: 'Длинное платье в рубчик, что скользит по фигуре, с одним боковым разрезом. Мягкое как вторая кожа.', compositionEn: 'Ribbed viscose', compositionRu: 'Вискоза в рубчик', careEn: 'Hand wash cold', careRu: 'Ручная стирка в холодной воде', colors: [OAT, GREY], image: '/images/white/products/p-192510012.jpg', nm: 192510012, gallery: ['/images/white/products/p-192510012-2.jpg']},
  {key: 13, en: 'Striped Belted Coat', ru: 'Пальто в полоску с поясом', cat: 'outerwear', price: 34900, descEn: 'A long oversized coat in a fine tonal stripe, closed with a belt. Considered ease over anything.', descRu: 'Длинное оверсайз-пальто в тонкую тональную полоску, на поясе. Продуманная лёгкость поверх чего угодно.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND, CHARCOAL], image: '/images/white/products/p-814720607.jpg', nm: 814720607, gallery: ['/images/white/products/p-814720607-2.jpg']},
  {key: 14, en: 'Spring Kimono Coat', ru: 'Пальто кимоно весеннее', cat: 'outerwear', price: 34900, descEn: 'A short kimono-cut coat for spring — wide sleeves, a wrap front, no fuss. Light layering.', descRu: 'Короткое пальто кроя кимоно для весны — широкий рукав, запа́х, без суеты. Лёгкий слой.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND], image: '/images/white/products/p-801438197.jpg', nm: 801438197, gallery: ['/images/white/products/p-801438197-2.jpg']},
  {key: 15, en: 'Draped Kimono Coat', ru: 'Пальто кимоно драповое', cat: 'outerwear', price: 34900, descEn: 'A draped wool kimono coat with a belt and a fluid fall. Architectural calm, cut to move.', descRu: 'Драповое пальто кимоно с поясом и текучим силуэтом. Архитектурное спокойствие, крой в движении.', compositionEn: 'Drape wool', compositionRu: 'Драп', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [CAMEL, CHARCOAL], image: '/images/white/products/p-795627344.jpg', nm: 795627344, gallery: ['/images/white/products/p-795627344-2.jpg']},
  {key: 16, en: 'Short Kimono Coat', ru: 'Пальто кимоно короткое', cat: 'outerwear', price: 34900, descEn: 'A cropped kimono coat with clean lines and a soft shoulder. The quiet finish to a look.', descRu: 'Укороченное пальто кимоно с чистыми линиями и мягким плечом. Тихое завершение образа.', compositionEn: 'Wool blend', compositionRu: 'Шерстяная смесь', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [SAND], image: '/images/white/products/p-795657866.jpg', nm: 795657866, gallery: ['/images/white/products/p-795657866-2.jpg']},
