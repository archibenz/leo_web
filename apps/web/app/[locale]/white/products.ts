...
export const WHITE_PRODUCTS: WhiteProduct[] = [
  ...
  {key: 18, en: 'Lace Peplum Vest', ru: 'Жилет с баской и кружевом', cat: 'tailoring', price: 33400, descEn: 'A tailored peplum vest finished with lace. The sharpness of tailoring, softened at the edge.', descRu: 'Костюмный жилет с баской, завершённый кружевом. Острота тайлоринга, смягчённая по краю.', compositionEn: 'Wool blend with lace', compositionRu: 'Шерстяная смесь с кружевом', careEn: 'Dry clean only', careRu: 'Только химчистка', colors: [IVORY, BROWN, BLACK], image: '/images/white/products/p-1224761706.jpg', nm: 1224761706},
