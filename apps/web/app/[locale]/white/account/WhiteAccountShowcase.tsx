        ...
        {!ready ? null : user ? (
          <div className="wv-rise">
            ...
            <div className="mt-3 divide-y border-y" style={{borderColor: HAIR}}>
              <a href={`/${locale}/white/favourites`} className="wv-menu-link flex min-h-12 items-center text-[14px]">
                {t('favourites')}{favCount > 0 ? ` · ${favCount}` : ''}
              </a>
              <a href={`/${locale}/white/bag`} className="wv-menu-link flex min-h-12 items-center text-[14px]">
                {t('bag')}{count > 0 ? ` · ${count}` : ''}
              </a>
            </div>
