            ...
            <div className="flex flex-col items-end gap-3 pt-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[#F2E6D8]/40 transition-colors duration-200 hover:text-[#CB11AB]"
                  aria-label="Wildberries"
                >
                  <svg className="h-[18px] w-[18px]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19.5 5.2l-3.04 12.87c-.04.18-.27.24-.38.1L12 12.5l5.34-5.98c.1-.12-.03-.28-.17-.22L9.6 11.5l-5.3-1.92c-.2-.07-.22-.35-.02-.44l14.9-6.22c.2-.08.38.1.32.28z"/>
                  </svg>
                </Link>
              </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-3 pt-1">
                ...
                <Link href="https://www.wildberries.ru/seller/609562" target="_blank" rel="noreferrer" className="text-[#F2E6D8]/40 transition hover:text-[#CB11AB]" aria-label="Wildberries">
                  <svg className="h-[18px] w-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="2 6 6 18 12 6 18 18 22 6" /></svg>
                </Link>
              </div>
            </div>
          </div>
