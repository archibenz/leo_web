...
// Тесты TickerForm переехали в components/editor/__tests__/TickerForm.test.tsx —
// «Куда ведёт» стало выбором, а не текстовым полем (task-ticker-ux-brief.md),
// и прежний блок здесь проверял именно свободный ввод в href.
