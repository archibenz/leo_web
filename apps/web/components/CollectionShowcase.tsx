    ...
    >
      ...
      >
        <div className="text-center px-6">
          <p className="font-accent text-[12px] uppercase tracking-[0.2em] text-inkSoft/70 sm:text-[14px] lg:text-[16px]">
            {subtitle}
          </p>
          <h3 className="mt-2 font-display text-2xl uppercase tracking-[0.08em] text-inkSoft sm:text-4xl lg:text-5xl">
            {title}
          </h3>
        </div>
      </div>
