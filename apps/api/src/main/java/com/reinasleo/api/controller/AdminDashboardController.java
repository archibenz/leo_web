...
public class AdminDashboardController {
    ...
    // Доливка дневных чисел в аналитику за последние N суток — на случай
    // простоя приёма дольше двух недель: короче расписание залечит само, оно
    // шлёт скользящие 14 суток. Код ответа — исход, а не «запрос принят»:
    // 503 — отправка не настроена, 502 — часть конвертов не принята (список
    // в теле).
